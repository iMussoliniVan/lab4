...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            canvas.draw(new Line2D.Double(center, shiftPoint(center, 0, 5.5)));
            Point2D.Double temp = shiftPoint(center, -5.5, 0);
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 0, 2)));
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 0, -2)));
            temp = shiftPoint(center, 5.5, 0);
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 0, 2)));
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 0, -2)));
            temp = shiftPoint(center, 0, 5.5);
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 2, 0)));
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, -2, 0)));
            temp = shiftPoint(center, 0, -5.5);
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, 2, 0)));
            canvas.draw(new Line2D.Double(temp, shiftPoint(temp, -2, 0)));
